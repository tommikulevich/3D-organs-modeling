...
session = False
if session:
    slicer.modules.MONAILabelWidget.current_sample["session_id"] = slicer.modules.MONAILabelWidget.logic.create_session(in_file)["session_id"]
else:
...
slicer.modules.segmentations.logic().ExportSegmentsClosedSurfaceRepresentationToFiles(outputFolder, segmentationNode, None,"STL", True, 1.0, False )
slicer.modules.segmentations.logic().ExportSegmentsClosedSurfaceRepresentationToFiles(outputFolder, segmentationNode, None,"OBJ", True, 1.0, False )